// 优化基于：（dp1）动态规划法 LongestCommonSequence
// 预处理部分
// opt1: 全文Equality 
// opt2：基于行的diff
// opt3: Common Prefix/Suffix
// opt4: Singular Insertion/Deletion (未实现)
// opt5: Two Edits (未实现)
// 后处理部分:merge合并，并且做一些语义化的处理，是的输出结果更具语义，利于阅读。
// opt6:Semantics (未实现)
#include<iostream>
#include<string>
#include<vector>
...
string diff_lined(const string& input1_,const string& input2_)
{
  ...
  vector<string> output_v=lines_get_LCS(lines1,lines2);
